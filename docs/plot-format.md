...
Внутри графика поддержаны идентификаторы, числа, вызовы функций, степени и деление. Для остальных выражений пока определяйте функцию или вектор обычным математическим регионом. Расширенные ссылки на объекты и длинные строки бинарного архива, логарифмические оси, маркеры точек, заголовки и 3D-графики требуют дальнейшей реализации и проверки. Это ограничения текущей реализации, а не модели выражений XML.
